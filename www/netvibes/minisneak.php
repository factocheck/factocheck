...
function received_data(xmlhttp) {
	...
	if (xmlhttp.status == 200 && xmlhttp.responseText.length > 10) {
		...
		if(new_items > 0) {
			...
			htm = '<div class="sneaker"><div class="sneakeritem"><div class="sneakertype"><strong>qué</strong></div><div class="sneakervotes"><strong><abbr title="factocheck">me</abbr></strong></div><div class="sneakerstory">&nbsp;<strong>noticia</strong></div><div class="sneakerwho">&nbsp;<strong>quién</strong></div></div>';
