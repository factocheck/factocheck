...
if(isset($_POST["phase"])) {
	switch ($_POST["phase"]) {
		case 1:
			do_header(_('enviar historia') . " 2/3", _('enviar historia'), false, false, '', false, false);
			if (! do_submit1()) {
			...
			break;
		case 2:
			do_header(_('enviar historia') . " 3/3", _('enviar historia'), false, false, '', false, false);
			if (! do_submit2()) {
				// Just to display error messages
				$link = new Link;
				$link->randkey = rand(10000,10000000);
	...
	check_already_sent();
	do_header(_('enviar historia') . " 1/3", _('enviar historia'), false, false, '', false, false);
	do_submit0();
}
